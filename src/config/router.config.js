...

        {
            ...
            children: [
                ...
                // Basic
                {
                    ...
                    name: 'basic',
                    meta: { title: '基础数据', icon: 'user', keepAlive: true, permission: ['user'] },
                    children: [{
                            path: '/basic/company',
                            name: 'company',
                            component: () =>
                                import ('@/views/basic/company/List'),
                            meta: { title: '公司管理', keepAlive: true, permission: ['user'] }
                        },
                        {
                            path: '/basic/shop',
                            name: 'shop',
                            component: () =>
                                import ('@/views/basic/shop/List'),
                            meta: { title: '店铺管理', keepAlive: true, permission: ['user'] }
                        }
                    ]
                }
            ]
